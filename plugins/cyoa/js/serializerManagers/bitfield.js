/*\
title: $:/plugins/mythos/cyoa/js/serializerManagers/bitfield.js
...
exports.amendRecord = function(entries) {
	var changed = false;
	var newEntries = Object.create(null);
		...
		if (info.tree === undefined) {
			...
			if(info.imply) {
				for(var i = 0; i < info.imply.length; i++) {
					...
					if(parentIndex > index || newEntries[parentIndex]) {
