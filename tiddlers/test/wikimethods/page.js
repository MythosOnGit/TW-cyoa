...
it("without config",function() {
	...
	test([{title: "A"},{title: "B.css",type: "text/css",tags: "$:/tags/mythos/cyoa/Stylesheet",text: "/* contains no actual css */"}],["A"]);
	// no cyoa javascript tiddlers
	test([{title: "A"},{title: "B.js",type: "application/javascript",tags: "$:/tags/mythos/cyoa/Javascript",text: "/* contains no actual javascript */"}],["A"]);
	// no drafts
...
it("with config",function() {
	...
	test([config,{title: "A"},{title: "B",tags: "exclude"},{title: "C.css",type: "text/css",tags: "$:/tags/mythos/cyoa/Stylesheet",text: "/* contains no actual css */"}],["A"]);
	test([config,{title: "A"},{title: "B",tags: "exclude"},{title: "C.js",type: "application/javascript",tags: "$:/tags/mythos/cyoa/Javascript",text: "/* contains no actual javascript */"}],["A"]);
